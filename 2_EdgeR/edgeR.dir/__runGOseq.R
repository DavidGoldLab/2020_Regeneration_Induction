...
factor_labeling = read.table("genes.count_table.NoFood_27hr_vs_WT.edgeR.DE_results.P0.001_C2.DE.subset", row.names=1)
...
background = read.table("genes.count_table.NoFood_27hr_vs_WT.edgeR.count_matrix", header=T, row.names=1)
...
go_enrich_filename = paste("genes.count_table.NoFood_27hr_vs_WT.edgeR.DE_results.P0.001_C2.DE.subset", '.GOseq.enriched', sep='')
    ...
    go_depleted_filename = paste("genes.count_table.NoFood_27hr_vs_WT.edgeR.DE_results.P0.001_C2.DE.subset", '.GOseq.depleted', sep='')
