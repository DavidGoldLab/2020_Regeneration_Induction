...
factor_labeling = read.table("subcluster_9.list.txt", row.names=1)
...
background = read.table("../GO_List.Background.DE_Genes.txt", header=T, row.names=1)
...
go_enrich_filename = paste("subcluster_9.list.txt", '.GOseq.enriched', sep='')
    ...
    go_depleted_filename = paste("subcluster_9.list.txt", '.GOseq.depleted', sep='')
